<?php require_once('fragment/authorise.inc.php'); ?><?php require_once('fragment/functions.inc.php'); ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row">
        ...
        <div class="col-25">
            <div class="container">
                ...
                <p>Tom Clancy's Ghost Recon: Wildlands Year 2 Gold Edition <span class="price">$24.95</span></p>
                <img src="StorePackage/Xgame6.jpg" height="75" width="68" />

                <hr>
                <p>Total <span class="price" style="color:black"><b>$24.95</b></span></p>
